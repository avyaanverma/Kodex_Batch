...
Javascript at its core synhronous and single threaded language

Synchronous means order meh chalna ek ke ek ke baad chalna,
it is an interpreted language. 

Interepretorr uses JIT Compilation method. 

Brendon Eich


What is console ? 
console is a playground for developers. 
